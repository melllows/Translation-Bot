...
client.on('ready', () => {
  ...
  //client.user.setGame(`:T help | :T invite | ${guildCount} servers & ${userCount} users! | Want to support Translate's existence? go here! https://kpop4.us/s/patreon`);
   client.user.setGame(`kpop4.us will be down for a while due to server maintenance | ":t english hello"`);
  console.log(`GOOGLE TRANSLATE BOT. Playing on ${guildCount} servers, currently serving ${userCount} users`);
/* const gmstr = [
  `:T help | ${userCount} users`,
  `:T help | ${guildCount} guilds`,
  `:T help | :T invite`,
  `:T help | :T invite | ${guildCount} servers & ${userCount} users! | Want to support Translate's existence? go here! https://kpop4.us/s/patreon`,
  `:T patreon | :T invite`,
  `https://kpop4.us/tanner`
]
...
if (!guild.iconURL) {
  ...
  .setTimestamp();
  client.channels.get('341775242839982080').send({embed: newGuild})
  }
  const newGuild = new Discord.RichEmbed()
  .setColor(0xFFFFFF)
  .setTitle(`New Guild Joined! Now at ${client.guilds.size} servers!`)
...
So, do you have any questions that may be asked in the survey? E. g. new troops or a change of troops, new game modes etc.. So give me lots of interesting suggestions!`, {to: 'ko'}).then(res => {
      if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
  ...
  if (args.startsWith("korean")) {
    let rescont = args.split(" ").slice(1).join(" ");
    translate(`${rescont}`, {to: 'ko'}).then(res => {
      if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
  ...
  if (args.startsWith("arabic")) {
    let rescont = args.split(" ").slice(1).join(" ");
    translate(`${rescont}`, {to: 'ar'}).then(res => {
      if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
  ...
  if (args.startsWith("afrikaans")) {
    let rescont = args.split(" ").slice(1).join(" ");
    translate(`${rescont}`, {to: 'af'}).then(res => {
      if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
 ...
 if (args.startsWith("albanian")) {
   let rescont = args.split(" ").slice(1).join(" ");
   translate(`${rescont}`, {to: 'sq'}).then(res => {
     if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("armenian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'hy'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("azerbaijani")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'az'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("basque")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'eu'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("belarusian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'be'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("bengali")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'bn'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("bosnian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'bs'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("bulgarian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'bg'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("catalan")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ca'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("cebuano")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ceb'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("chichewa")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ny'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("chinese-simplified")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'zh-cn'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("chinese-traditional")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'zh-tw'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("corsican")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'co'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("croatian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'hr'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("czech")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'cs'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("danish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'da'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("dutch")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'nl'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("english")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'en'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("esperanto")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'eo'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("estonian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'et'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("filipino")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'tl'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("finnish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'fi'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("french")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'fr'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("frisian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'fy'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("galician")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'gl'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("georgian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ka'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("german")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'de'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("greek")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'el'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("gujarati")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'gu'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("haitian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ht'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("hausa")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ha'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("hawaiian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'haw'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("hebrew")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'iw'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("hindi")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'hi'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("hmong")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'hmn'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("hungarian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'hu'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("icelandic")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'is'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("igbo")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ig'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("indonesian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'id'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("irish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ga'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("italian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'it'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("japanese")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ja'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("javanese")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'jw'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("kannada")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'kn'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("kazakh")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'kk'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("khmer")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'km'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("kurdish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ku'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("kyrgyz")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ky'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("lao")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'lo'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("latin")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'la'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("latvian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'lv'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("lithuanian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'lt'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("luxembourgish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'lb'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("macedonian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'mk'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("malagasy")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'mg'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("malay ")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ms'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("malayalam")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ml'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("maltese")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'mt'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("maori")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'mi'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("marathi")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'mr'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("mongolian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'mn'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("myanmar")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'my'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("nepali")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ne'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("norwegian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'no'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("pashto")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ps'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("persian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'fa'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("polish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'pl'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("portuguese")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'pt'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("punjabi")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ma'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("romanian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ro'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("russian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ru'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("samoan")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sm'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("scotsGaelic")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'gd'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("serbian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sr'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("sesotho")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'st'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("shona")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sn'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("sindhi")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sd'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("sinhala")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'si'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("slovak")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sk'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("slovenian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sl'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("somali")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'so'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("spanish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'es'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("sudanese")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'su'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("swahili")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sw'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("swedish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'sv'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("tajik")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'tg'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("tamil")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ta'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("telugu")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'te'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("thai")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'th'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("turkish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'tr'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("ukrainian")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'uk'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("urdu")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'ur'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("uzbek")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'uz'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("vietnamese")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'vi'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("welsh")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'cy'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("xhosa")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'xh'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("yiddish")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'yi'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("yoruba")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'yo'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("zulu")) {
  let rescont = args.split(" ").slice(1).join(" ");
  translate(`${rescont}`, {to: 'zu'}).then(res => {
    if (res.text.length > 200) {
  return message.channel.send(`${res.text}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
...
if (args.startsWith("flipped")) {
  ...
  let res = flip(`${rescont}`);
    if (res.length > 200) {
  return message.channel.send(`${res}`, {code: "xl"});
}
const embed2 = new Discord.RichEmbed()
    .setColor(0xFFFFFF)
...
if (args.startsWith("gangsta")) {
  ...
  G.string(`${rescont}`, function(error, translation) {
    if (translation.length > 200) {
      return message.channel.send(`${translation}`, {code: "xl"});
    }
const embed2 = new Discord.RichEmbed()
    .setColor(0xFFFFFF)
...
function(err, result) {
    if (!err) {
      if (result.toString().length > 200) {
        return message.channel.send(`${result.toString()}`, {code: "xl"});
      }
const embed2 = new Discord.RichEmbed()
      .setColor(0xFFFFFF)
...
if (!message.author.avatarURL) {
  ...
  client.channels.get(`337228369295048706`).send({embed: CMD2embed});
  return;
}
...
const CMDembed = new Discord.RichEmbed()
  ...
  .addField(`Channel Name`, `${message.channel.name}`, true)
  .addField(`Translation`, `${message.content}`, true);
  client.channels.get(`337228369295048706`).send({embed: CMDembed});
} // Translate End
...
if (message.content.toLowerCase() === ":t help") {
  message.reply("Want to know how to use the Translate Bot? View the webpage here! https://kpop4.us/s/translate | **If you like Translate, please consider making a pledge on our Patreon, every little bit helps pay for the costs to keep Translate online** https://kpop4.us/s/patreon");
}
...
if (message.content.toLowerCase().startsWith(":t suggest")) {
  ...
  client.channels.get(`314819480817762304`).send({embed});

  const embed2 = new Discord.RichEmbed()
  .setColor(0xFFFFFF)
  .setTitle(`:wrench: Suggestion sent! If you like Translate, please consider making a pledge on our Patreon, every little bit helps pay for the costs to keep Translate online https://kpop4.us/s/patreon`);
  message.channel.send({embed: embed2});
}
...
if (message.content.toLowerCase().startsWith(":t bug")) {
  ...
  client.channels.get(`315280472378966016`).send({embed});
...
[Server Uptime]: ${JSON.stringify(uptime)} hours`, {code: 'ini'});
          });
      });
  });
}
...
if(message.content.toLowerCase() === ":t patreon") {
  message.reply(`https://kpop4.us/s/patreon`);
}
